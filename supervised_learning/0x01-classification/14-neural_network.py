...
class NeuralNetwork:
    ...
    def forward_prop(self, X):
        """
        Method that alculates the forward propagation of the neural network
            - X: np array with the input data of shape (nx, m)
        """
    ...
    def cost(self, Y, A):
        ...
        Method that calculates the cost of the model using logistic regression
             - Y: np array with correct labels of shape (1, m)
             - A: np array with the activated output of shape (1, m)
        """
    ...
    def evaluate(self, X, Y):
        """
        Method that evaluates the neural network prediction
             - X: np array with input data of shape (nx, m)
             - Y: np array with correct label of shape (1, m)
        """
        self.forward_prop(X)
    ...
    def gradient_descent(self, X, Y, A1, A2, alpha=0.05):
        ...
        Method that calculates one pass of gradient descent on the neuron
             - X: np array with input data of shape (nx, m)
             - Y: np array with correct labels of shape (1, m)
             - A1: np array with activated hidden layer output of shape (1, m)
             - A2: np array with activated output of shape (1, m)
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05):
        ...
        Method that trains the neural network
             - X: np array with input data of shape (nx, m)
             - Y: np array with correct labels of shape (1, m)
             - iterations: iterations of the training
             - alpha: learning rate
        """
