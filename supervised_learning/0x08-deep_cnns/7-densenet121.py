#!/usr/bin/env python3
""" Module that contains densenet121 function """
...
def densenet121(growth_rate=32, compression=1.0):
    ...
    max_pooling = K.layers.MaxPooling2D(
        pool_size=(3, 3), strides=(2, 2), padding='same')(conv_7x7)
    ...
    average_pooling = K.layers.AveragePooling2D(
        pool_size=(7, 7), strides=None, padding='same')(DB_4)

    output = K.layers.Dense(
        units=1000, activation='softmax',
        kernel_initializer=initializer_kernel_weights)(average_pooling)
