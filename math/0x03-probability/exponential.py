...
class Exponential:
    ...
    def pdf(self, x):
        """
        Instance method that calculates the value of the PDF for a given time
        period
           - x: time period
        Return: the PDF value for x or 0 if x is out of range
        """
        if x < 0:
            return 0
    ...
    def cdf(self, x):
        ...
        period
           - x: time period
        Return: the CDF value for x or 0 if x is out of range
        """
        if x < 0:
            return 0
