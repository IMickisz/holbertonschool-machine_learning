...
class Binomial:
    ...
    def factorial(self, n):
        """
        Instance method that calculates the factorial for a given number n > 0
    ...
    def pmf(self, k):
        """
        Instance method that calculate the PDF for a given number of
        “successes”
           - k: the number of “successes”
        Return: PMF value for k or 0 if k is out of range
        """
        if k < 0:
            return 0
        if k <= self.n:
